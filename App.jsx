...
export default function App() {
  ...
  const s = {
    wrap: { minHeight: "100vh", background: "#f4fdfb", fontFamily: "'Nunito', 'Segoe UI', sans-serif", padding: "0 0 60px" },
    ...
    btn: (color = "teal") => ({
      padding: "8px 16px", borderRadius: 18, border: `1.5px solid ${color === "teal" ? "#7accc2" : color === "blush" ? "#ddb0cc" : "#c8ece6"}`,
      background: color === "teal" ? "#7accc2" : color === "blush" ? "#e8c4d8" : "#f0f9f7",
      color: color === "teal" ? "#fff" : color === "blush" ? "#8a4a6e" : "#2d7a70",
    ...
    <div style={s.wrap}>
      ...
      <div style={s.inner}>
        ...
        <div style={s.tabs}>
          ...
          <button style={s.tab(tab === "contacts")} onClick={() => setTab("contacts")}>🤍 Emergency Contacts</button>
        </div>
